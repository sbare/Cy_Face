...
- (void)drawRect:(CGRect)rect
{
    ...
    if (displayImage)
    {
        ...
        //
//        UIImage *image = [UIImage imageWithCIImage:displayImage];
//   
//       
//        
//        float fSize = 0.5;
//        [image resizableImageWithCapInsets:UIEdgeInsetsMake(image.size.height*fSize, image.size.width*fSize, image.size.height*fSize, image.size.width*fSize)resizingMode:UIImageResizingModeStretch];
//
//      
//        [self.ciContext drawImage:image.CIImage inRect:rectDraw fromRect:[displayImage extent]];
...
//        path = [path stringByAppendingPathComponent:@"/Users/apple/Desktop/xxx.jpg"];
//
//
//        CIContext * ciContext = [[CIContext alloc]init];
//
//        CGImageRef cgImage = [ciContext createCGImage:displayImage fromRect:displayImage.extent];
//
//        CGDataProviderRef provider = CGImageGetDataProvider(cgImage);
//        NSData* data = (id)CFBridgingRelease(CGDataProviderCopyData(provider));
//
//        [data writeToFile:@"/Users/apple/Desktop/xxx.jpg" atomically:YES];
